...
An Expense Tracker Web App built with ASP.NET Core Web API that helps users manage their income and expenses securely. The application supports user management, JWT-based authentication, and transaction handling using modern backend best practices.
...
API-first design suitable for frontend integration
